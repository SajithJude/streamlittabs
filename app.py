...
if st.button("Next"):
    ...
    op = hc.option_bar(option_definition=option_data[1:],title='Feedback Response',key='PrimaryOption',override_theme=over_theme,font_styling=font_fmt,horizontal_orientation=True)
